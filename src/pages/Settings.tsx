...
import { WhitelistEntry } from '../types'; // Ensure to import the WhitelistEntry type
      ...
      <div className="mx-auto max-w-270">
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="flex gap-2.5">
                        <button className="text-sm hover:text-primary" type="button">Delete</button>
                        <button className="text-sm hover:text-primary" type="button">Update</button>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button className="flex justify-center rounded border border-stroke py-2 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white" type="button" onClick={handleCancel}>Cancel</button>
                    <button className="flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90" type="submit">Save</button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div className="col-span-5">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="p-7">
              <div className="mb-5.5">
                <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="newIP">Add IP to Whitelist</label>
                <div className="flex">
                  <input
                    className="w-full rounded-l border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                    type="text"
                    name="newIP"
                    id="newIP"
                  ...
                  />
                  <button
                    className="rounded-r bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                    type="button"
                    onClick={handleAddIP}
                  >
                    Add
              ...
              <div className="mb-5.5">
                <h4 className="mb-3 block text-sm font-medium text-black dark:text-white">Current Whitelist</h4>
                <ul>
                  {whitelist.map(entry => (
